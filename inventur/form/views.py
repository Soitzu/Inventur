...
def user_form(request):
    if request.method == 'POST':
        ...
        mini_pc = request.POST.get('mini_pc') is not None
        laptop = request.POST.get('laptop') is not None
        drucker = request.POST.get('drucker') is not None
        monitore = request.POST.get('monitore') is not None
